  ...
  return (
    <div className='container mx-auto mt-[100px]'>
      <div className="w-full flex justify-between items-start">
        <div className="w-[25%] flex flex-col gap-y-3 justify-start max-h-[850px] overflow-y-scroll">
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <div className="flex flex-wrap items-center text-lg font-semibold text-white gap-x-3 gap-y-2">
              <button className="bg-gray-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-blue-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-red-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-yellow-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-purple-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-pink-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-indigo-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-white w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-black w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-green-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-violet-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-slate-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-stone-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-orange-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-amber-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-lime-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-emerald-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
              <button className="bg-teal-500 w-8 h-8 rounded-full transition-transform hover:scale-110 capitalize flex items-center gap-2"></button>
        ...
        <div className="w-[75%] flex flex-col justify-between gap-y-10">
          <div className="flex items-center justify-between">
            {/* place for display the filters name */}
